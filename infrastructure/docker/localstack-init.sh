...
awslocal sqs create-queue --queue-name product-ingestion-queue \
    --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:us-east-1:000000000000:product-ingestion-dlq\",\"maxReceiveCount\":\"3\"}"}' || true
...
echo "  - S3 Bucket: product-ingestion-bucket"
echo "  - SQS Queue: product-ingestion-queue"
echo "  - SQS DLQ: product-ingestion-dlq"
echo "  - EventBridge Bus: product-events"
echo "============================================"
